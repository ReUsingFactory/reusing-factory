...
function aT(){document.querySelectorAll('[data-t]').forEach(el=>{el.innerHTML=t(el.dataset.t)});document.querySelectorAll('[data-ph]').forEach(el=>{el.placeholder=t(el.dataset.ph)});var ln=t('legal_de_note');['agb-legal-note','wid-legal-note','imp-legal-note'].forEach(function(id){var el=document.getElementById(id);if(el)el.innerHTML=ln;});}
